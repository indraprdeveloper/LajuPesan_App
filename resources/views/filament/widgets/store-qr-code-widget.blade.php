<x-filament-widgets::widget>
    <x-filament::section class="fi-section">
        <div class="flex flex-col md:flex-row items-center gap-8 p-2">
            
            <!-- Left Side: QR Code Panel -->
            <div class="flex flex-col items-center gap-3 bg-gray-50/70 dark:bg-gray-900/40 p-5 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm">
                ...
                <!-- URL Badge -->
                <div class="inline-flex items-center gap-1.5 py-1 px-3.5 rounded-full text-xs font-semibold border"
                    ...
                    <span>{{ str_replace(['http://', 'https://'], '', $this->getStoreUrl()) }}</span>
                </div>
            </div>
            ...
            <div class="flex-1 text-left space-y-5">
                ...
                <!-- Action Buttons -->
                <div class="flex flex-wrap items-center justify-start gap-3" style="margin-top: 1.75rem;"
                     x-data="{ 
                        copied: false,
                        ...
                        downloadPng() {
                            ...
                            img.onload = () => {
                                ...
                                canvas.toBlob((blob) => {
                                    ...
                                    link.download = 'qrcode-' + this.storeUsername + '.png';
                    ...
                    <button @click="downloadPng" type="button"
                       class="inline-flex items-center gap-2 px-4 py-2.5 text-white rounded-lg font-semibold text-sm shadow-sm transition-all duration-150 focus:outline-none cursor-pointer"
                    ...
                    <button @click="copyToClipboard" type="button"
                        ...
                        <!-- SVG Copy Icon -->
                        <svg x-show="!copied" class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor">
                        ...
                        <!-- SVG Check Icon -->
                        <svg x-show="copied" x-cloak class="w-4 h-4 text-green-600 dark:text-green-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor">
                    ...
                    <a href="{{ $this->getStoreUrl() }}" target="_blank"
                       class="inline-flex items-center gap-2 px-4 py-2.5 bg-transparent rounded-lg font-semibold text-sm border transition-colors duration-150 focus:outline-none"
