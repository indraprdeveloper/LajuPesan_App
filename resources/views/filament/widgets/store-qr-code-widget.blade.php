<x-filament-widgets::widget>
    <x-filament::section class="fi-section">
        <div class="flex flex-col md:flex-row items-center gap-8 p-2 qr-code-widget-wrapper">
            ...
            <div class="qr-code-panel animate-fade-in">
                <div id="qr-code-container" class="relative w-44 h-44 flex items-center justify-center">
                    {!! $this->getQrCode() !!}
                </div>
                
                <!-- URL Badge -->
                <div class="inline-flex items-center gap-1.5 py-1 px-3.5 rounded-full text-xs font-semibold max-w-full overflow-hidden qr-url-badge">
                    <!-- SVG Globe Icon -->
            ...
            <div class="flex-1 space-y-5 w-full qr-code-details">
                ...
                <div class="flex gap-3 qr-code-buttons" style="margin-top: 1.75rem;"
                    ...
                    <button @click="downloadPng" type="button"
                       class="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg font-semibold text-sm shadow-sm transition-all duration-150 focus:outline-none cursor-pointer qr-code-btn qr-code-btn-primary">
                        <!-- SVG Download Icon -->
                    ...
                    <button @click="copyToClipboard" type="button"
                            class="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg font-semibold text-sm shadow-sm transition-all duration-150 focus:outline-none qr-code-btn qr-code-btn-secondary">
                        <!-- SVG Copy Icon -->
                    ...
                    <a href="{{ $this->getStoreUrl() }}" target="_blank"
                       class="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg font-semibold text-sm transition-colors duration-150 focus:outline-none qr-code-btn qr-code-btn-outline">
